// services/QuestionsAnswers/downloadLastUpload.js
const path = require('path');
const fs = require('fs').promises;

/**
 * Service to download the last uploaded CSV file for the logged-in user (questionsanswers uploads).
...
const downloadLastUploadService = () => async (req, res) => {
    try {
        ...
        // Use files/managequestionsanswers/{uploaderId}/ as the directory
        const userDirectory = path.join(__dirname, '..', '..', 'files', 'managequestionsanswers', uploaderId.toString());
